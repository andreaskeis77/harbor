...
from harbor.operator_surface import (
    ...
    smoke_review_queue_source_promotion_slice_payload,
...
def command_smoke_review_queue_slice() -> int:
    print_json(smoke_review_queue_slice_payload())
    return 0


def command_smoke_search_run_slice() -> int:
    print_json(smoke_search_run_slice_payload())
    return 0


def command_smoke_search_result_candidate_slice() -> int:
    print_json(smoke_search_result_candidate_slice_payload())
    return 0
...
def command_smoke_review_queue_source_promotion_slice() -> int:
    print_json(smoke_review_queue_source_promotion_slice_payload())
    return 0


def command_smoke_promotion_duplicate_guard_slice() -> int:
    print_json(smoke_promotion_duplicate_guard_slice_payload())
    return 0
